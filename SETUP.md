...
| Auth tables | Service startup | `auth-service` TypeORM sync |
...
| Frontend (Vite) | 3000 | — |
| API Gateway | 3009 | — |
| user-service | 3002 | `hashibasha_user` |
| auth-service | 3003 | `hashibasha_auth` |
| notification-service | 3004 | `hashibasha_notification` |
| permission-service | 3005 | `hashibasha_permission` |
| org-service | 3012 | `hashibasha_org` |
| location-service | 3013 | `hashibasha_location` |
| language-service | 3014 | `hashibasha_language` |
...
This guide is for **local development**. For production deployment, change default passwords, disable TypeORM `synchronize` on auth-service, and use managed PostgreSQL with SSL. See deployment discussions in project documentation.
