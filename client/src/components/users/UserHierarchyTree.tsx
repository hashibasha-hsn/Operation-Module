...
export default function UserHierarchyTree({
  ...
  const visibleRoots = useMemo(() => {
    ...
    return rootUsers.filter((root) => subtreeHasMatch(root, searchQuery, getDirectReports));
  }, [rootUsers, searchQuery, getDirectReports]);
  const allExpandableIds = useMemo(
    () => collectExpandableIds(rootUsers, getDirectReports),
    [rootUsers, getDirectReports],
  );
  const searchExpandableIds = useMemo(
    () => collectExpandableIdsForSearch(visibleRoots, searchQuery, getDirectReports),
    [visibleRoots, searchQuery, getDirectReports],
  );
