...
const FEATURE_QUICK_LINKS = [
  ...
  { labelKey: "actionPointsReports", href: "/feature-reports", icon: AlertCircle },
  { labelKey: "ticketReports", href: "/feature-reports", icon: Ticket },
  { labelKey: "assetReports", href: "/feature-reports", icon: Package },
  { labelKey: "learningReports", href: "/standard-reports/learning-org-report", icon: GraduationCap },
  { labelKey: "assessmentReports", href: "/standard-reports/assessment-org-report", icon: CheckCircle },
] as const;
