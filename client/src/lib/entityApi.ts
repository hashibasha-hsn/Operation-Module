...
function buildEntitiesUrl(search?: string, organizationId = getOrganizationId()) {
...
export async function fetchEntities(search?: string, organizationId = getOrganizationId()) {
